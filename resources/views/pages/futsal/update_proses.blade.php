...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        ...
        <form id="aulaForm" method="post" action="{{ route('aula.upload-file',$id) }}" enctype="multipart/form-data" >
                    ...
                    @if(Auth::user()->hasRole('member') || $data->created_by == Auth::user()->id)
                        <div class="col-md-4 disabledTrue">
                            <div class="form-group">
                                ...
                                <input type="text" hidden class="form-control unable" name="futsal_id" value="{{$data->id}}">
                                <input type="file" class="form-control readOnly" name="file_futsal">
                            </div>
                        </div>
                    @endif
                    ...
                    @if(!empty($file_data))
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <a href="{{route('futsal.download',$data->id)}}" class="btn btn-sm btn-info btn-block"><span class="fa fa-download"></span></a>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{route('futsal.index')}}" class="btn btn-secondary backBtn">Back</a>
            </div>
        </form>
        <!--end::Form-->
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="statusForm" method="post" action="{{ route('futsal.upload-file',$id) }}" enctype="multipart/form-data" >
                        {{ csrf_field() }} {{ method_field('POST') }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
