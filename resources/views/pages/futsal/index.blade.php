                ...
                <div class="row mt-8">
                    <div class="col-lg-12">
                        ...
                        @if(Auth::user()->hasRole('member'))
                            <a href="{{route('futsal.create')}}" class="btn btn-sm btn-info float-right">Create Booking</a>
                        @else
                            <a href="{{route('futsal.create-admin')}}" class="btn btn-sm btn-info float-right">Create Booking</a>
                        @endif
                    </div>
                </div>
            </form>
