...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        <!--begin::Form-->
        @role('member')
        <form id="aulaForm" method="post" action="{{empty($id) ? route('futsal.store') : route('futsal.update',$id)}}" enctype="multipart/form-data" >
            @endrole
            @role('admin')
            <form id="aulaForm" method="post" action="{{empty($id) ? route('futsal.store-admin') : route('futsal.update-admin',$id)}}" enctype="multipart/form-data" >
                @endrole
