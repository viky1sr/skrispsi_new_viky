...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
       ...
       @if(Auth::user()->hasRole('member') && $data->status == 1)
        ...
        <form id="perpustakaanForm" method="post" action="{{ route('perpustakaan.upload-file',$id) }}" enctype="multipart/form-data" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 disabledTrue">
                        <div class="form-group">
                            ...
                            <input type="text" hidden class="form-control unable" name="perpustakaan_id" value="{{$data->id}}">
                            <input type="file" class="form-control readOnly" name="file_perpustakaan">
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <a href="{{route('perpustakaan.download',$data->id)}}" class="btn btn-sm btn-info btn-block"><span class="fa fa-download"></span></a>
                        </div>
                    </div>
                    @endif
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateStatusLabel">Update Status Perpustakaan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="statusForm" method="post" action="{{ route('perpustakaan.upload-file',$id) }}" enctype="multipart/form-data" >
                        {{ csrf_field() }} {{ method_field('POST') }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span class="text-danger">Silakan upload file pendukung , jika dalam waktu 2 jam tidak upload file pendukung, booking akan auto di reject.
                    Terimakasi
                    </span>
                </div>
                <div class="modal-footer">
