                ...
                <div class="row mt-8">
                    <div class="col-lg-12">
                        ...
                        @if(Auth::user()->hasRole('member'))
                            <a href="{{route('perpustakaan.create')}}" class="btn btn-sm btn-info float-right">Create Booking</a>
                        @else
                            <a href="{{route('perpustakaan.create-admin')}}" class="btn btn-sm btn-info float-right">Create Booking</a>
                        @endif
                    </div>
                </div>
            </form>
        ...
        var KTDatatablesSearchOptionsAdvancedSearch = function() {
			...
			<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                    ...
                    buttons: [
                        {
                            extend: 'print',
                            title: 'Reporting Booking Ruang Perpustakaan',
                            exportOptions: {
                                columns: [ 0,1,2,3,4,5]
                            }
                        },
                    ...
                    serverSide: true,
                    ajax: {
                        url : '{{route('perpustakaan.data-tables')}}',
                        type: 'GET',
                        data: function (d) {
                    ...
                    columns: [
                        ...
                        {data: 'id', name: 'id' , searchable: false , orderable: false ,render : function(data, type , row) {
                                return '<a href="perpustakaan/show/'+row.id+'" title="show" ><i class="fa fa-fw fa-eye text-info"></i></a>'
                            }
                        }
                    ],
                });
