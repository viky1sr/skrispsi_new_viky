                ...
                <div class="row mt-8">
                    <div class="col-lg-12">
                        ...
                        @if(Auth::user()->hasRole('member'))
                            <a href="{{route('aula.create')}}" class="btn btn-sm btn-info float-right">Create Booking</a>
                        @else
                            <a href="{{route('aula.create-admin')}}" class="btn btn-sm btn-info float-right">Create Booking</a>
                        @endif
                    </div>
                </div>
            </form>
        ...
        var KTDatatablesSearchOptionsAdvancedSearch = function() {
			...
			<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                    ...
                    buttons: [
                        {
                            extend: 'print',
                            title: 'Reporting Booking Ruang Aula',
                            exportOptions: {
                                columns: [ 0,1,2,3,4,5]
                            }
                        },
