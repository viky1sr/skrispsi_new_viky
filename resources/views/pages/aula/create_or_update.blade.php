...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        <!--begin::Form-->
        @role('member')
        <form id="aulaForm" method="post" action="{{empty($id) ? route('aula.store') : route('aula.update',$id)}}" enctype="multipart/form-data" >
            @endrole
            @role('admin')
            <form id="aulaForm" method="post" action="{{empty($id) ? route('aula.store-admin') : route('aula.update-admin',$id)}}" enctype="multipart/form-data" >
                @endrole
