<script type="text/javascript">
    ...
    c1 = $('#dataTableHomeCare').DataTable({
        oLanguage: {
        ...
        serverSide : true,
        ajax: {
            url: '{{route('master-data.home-care.datatable')}}',
            type: 'GET',
            data: function (d){
        ...
        columns : [
            ...
            {data: 'created_at',name: 'created_at', render: (data,type,row) => {
                    let today = new Date(row.created_at);
