...
<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
    <!--begin::Logo-->
    <a href="">
        <img alt="Logo" src="{{asset('logo_viera.png')}}" class="logo-default max-h-30px" />
    </a>

    <h1 class="text-center">Viera Mom & Baby SPA</h1>
    <!--end::Logo-->
    <!--begin::Toolbar-->
            ...
            <div id="kt_header" class="header header-fixed">
                ...
                <div class="container d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-none d-lg-flex align-items-center mr-3">
                        ...
                        <!--begin::Logo-->
                        <a href="">
                            <img alt="Logo" src="{{asset('logo_viera.png')}}" class="logo-sticky max-h-35px" />
                        </a>
                        <!--end::Logo-->
                    </div>
        ...
        <div id="kt_header" class="header header-fixed">
            ...
            <div class="container d-flex align-items-stretch justify-content-between">
                ...
                <div class="d-none d-lg-flex align-items-center mr-3">
                    ...
                    <!--begin::Logo-->
                    <a href="">
                        <img alt="Logo" src="{{asset('logo_viera.png')}}" class="logo-sticky max-h-60px" />
                    </a>
                    <!--end::Logo-->
                </div>
                            ...
                            <div class="card-toolbar">
                                <a href="" class="btn btn-success font-weight-bolder font-size-sm">
													<span class="svg-icon svg-icon-md svg-icon-white">
                                                        ...
                                                        <span class="svg-icon svg-icon-info svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo5\dist/../src/media/svg/icons\Communication\Adress-book2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
